...
const smsLista1 = () => { return `🌟 INFORMASI AzkanBot 🌟`}
...
const smsLista7 = () => { return `🐈 PASANG AzkanBot 🐈`}
...
const smsCont7 = () => { return `${global.bahasaAK['smsAvisoAG']()}*TIDAK MEMILIKI BERLIAN!! 💎 ANDA DAPAT PERGI KE TOKO DENGAN PERINTAH*`}
const smsCont8 = () => { return ` *BERLIAN 💎 DIGUNAKAN*`}
const smsCont9 = () => { return `${global.bahasaAK['smsAvisoAG']()}*BUTUH TINGKATNYA ➡️*`}
...
//_antilink.js
const smsAdwa = () => { return `${global.bahasaAK['smsAvisoEG']()}*SEBAGAI ANDA ADMIN DI GRUP INI ANDA TIDAK AKAN DIHAPUS*`}
const smsEnlaceWat = () => { return `${bahasaAK['smsAvisoAG']()}*LINK WHATSAPP TERBANNED TERDETEKSI DI GRUP INI*\n\n*SAYA LANJUTKAN UNTUK MENGHAPUS ANDA*`}

//_antilink2.js
const smsEnlaceWatt = () => { return `${bahasaAK['smsAvisoAG']()}LINK TERLARANG MENGANDUNG HTTPS TERDETEKSI DI GRUP INI\n\nSAYA LANJUTKAN UNTUK MENGHAPUS ANDA`}
...
//Kesalahan
const smsMalError = () => { return `${bahasaAK['smsAvisoFG']()}\`\`\`SEBUAH KESALAHAN YANG TIDAK TERDUGA TELAH TERJADI.\`\`\``}
const smsMalError2 = () => { return `${bahasaAK['smsAvisoFG']()}\`\`\`KENYAMANAN TELAH TIMBUL. COBA LAGI.\`\`\``}
const smsMalError3 = () => { return `${bahasaAK['smsAvisoFG']()}\`\`\`ADA YANG SALAH, LAPORAN PERINTAH INI MENGGUNAKAN:\`\`\`\n`}
...
const smsModP2 = () => { return `Aktifkan fungsi agar semua orang dapat menggunakan AzkanBot`}
const smsModAd1 = () => { return `🛂 MODE ADMIN`}
const smsModAd2 = () => { return `Hanya Admin yang dapat menggunakan AzkanBot di Grup`}
...
//_autosticker.js
const smsAutoStik = () => { return `${bahasaAK['smsAvisoFG']()}*VIDEO TIDAK HARUS BERAKHIR LEBIH DARI 7 DETIK.*`} 
...
//afk-afk.js
const smsAfkQ1 = (usedPrefix, command) => { return `${bahasaAK['smsAvisoMG']()}*TULIS ALASAN KENAPA TIDAK AKTIF (AFK)*\n\n*CONTOH:*\n*${usedPrefix + command}* Saya akan mengerjakan pekerjaan rumah`} 
const smsAfkQ2 = () => { return `${bahasaAK['smsAvisoMG']()}*MINIMUM 10 KARAKTER HARUS MENJADI ALASAN*`} 
const smsAfkM1A = () => { return `*JANGAN TAG*`} 
const smsAfkM1B = () => { return `*AKAN AFK TIDAK AKTIF*\n\n*ALASAN TIDAK AKTIFNYA AFK:*`} 

//anonymous_chat.js
const smsChatAn1 = () => { return `${bahasaAK['smsAvisoFG']()}*ANDA TIDAK DALAM CHAT ANONIM*`} 
...
const smsChatAn4 = () => { return `${bahasaAK['smsAvisoRG']()}🪐 *ANDA MENINGGALKAN CHAT ANONIM*`} 
const smsChatAn5 = () => { return `${bahasaAK['smsAvisoAG']()}*PENGGUNA LAIN MENINGGALKAN CHAT ANONIM*`}  
const smsChatAn6 = () => { return `*JIKA INGIN KE CHAT ANONIM LAIN GUNAKAN PERINTAH #start ATAU GUNAKAN TOMBOL DI BAWAH INI*\n`} 
const smsChatAn7 = () => { return `${bahasaAK['smsAvisoAG']()}*ANDA MASIH DALAM CHAT ANONIM ATAU MENUNGGU SESEORANG UNTUK BERGABUNG KE CHAT*`} 
...
const smsChatAn10 = () => { return `${bahasaAK['smsAvisoEG']()}✨ *MEREKA BISA CHAT SEKARANG*`} 
const smsChatAn11 = () => { return `*SESEORANG BERGABUNG DENGAN CHAT ANONIM!!*`} 
const smsChatAn12 = () => { return `❇️ PENGGUNA LAIN`} 
const smsChatAn13 = () => { return `${bahasaAK['smsAvisoRG']()}🐈 *MENUNGGU SESEORANG UNTUK BERGABUNG DENGAN CHAT ANONIM, HARAP SABAR*`} 
...
const smsMalused2 = () => { return `${bahasaAK['smsAvisoMG']()}🐈 *ANDA HARUS MENGGUNAKAN PERINTAH SEPERTI CONTOH INI:*\n`}
const smsMalused3 = () => { return `${bahasaAK['smsAvisoMG']()}🐈 *ANDA HARUS MENGGUNAKAN PERINTAH ATAU MERESPON PESAN SESEORANG SEPERTI CONTOH INI:*\n`}
...
//grupo-add.js
const smsAddB1 = () => { return `${bahasaAK['smsAvisoFG']()}*TIDAK BISA MENAMBAH NOMOR, HARAP VERIFIKASI BENAR, MUNGKIN BARU KELUAR ATAU PRIVASI ANDA SUDAH DITETAPKAN.*`}
const smsAddB2 = () => { return `${bahasaAK['smsAvisoFG']()}*TIDAK DAPAT MENAMBAHKAN NOMOR, MEMVERIFIKASI BENAR, ATAU MENAMBAHKANNYA SECARA MANUAL.*`}
...
const smsAdveu1 = () => { return `${bahasaAK['smsAvisoAG']()}*HANYA DAPAT DIGUNAKAN JIKA FUNGSI DIAKTIFKAN:*\n`}
const smsAdveu2 = () => { return 'Alasan'}
const smsAdveu3 = () => { return `${bahasaAK['smsAvisoMG']()}*INGAT UNTUK MENULIS ALASAN UNTUK PERINGATAN*\n`}
...
//grupo-kick.js
const smskick1 = () => { return `${bahasaAK['smsAvisoAG']()}*TAG ORANG ATAU BALAS PESAN ORANG YANG INGIN ANDA HAPUS*\n\n*CONTOH: `}
...
//grupo-setbye.js
const smsSetB = () => { return `${bahasaAK['smsAvisoEG']()}*PERPISAHAN GRUP TELAH DIKONFIGURASI*`}
const smsSetB2 = () => { return `${bahasaAK['smsAvisoIIG']()}🙌 *_TULIS PESAN PERPISAHAN_*\n*_OPSIONAL, ANDA DAPAT MENGGUNAKAN APA DENGAN "@" UNTUK MENAMBAHKAN INFORMASI LEBIH LANJUT:_*\n\n*⚡ @user (Sebutkan kepada pengguna)*\n\n*INGAT BAHWA "@" ITU OPSIONAL*`}

//grupo-setwelcome.js
const smsSetW = () => { return `${bahasaAK['smsAvisoEG']()}*SAMBUTAN GRUP TELAH DIATUR*`}
const smsSetW2 = () => { return `${bahasaAK['smsAvisoIIG']()}🙌 *_TULIS PESAN SELAMAT DATANG_*\n*_OPSIONAL, ANDA DAPAT MENGGUNAKAN APA DENGAN "@" UNTUK MENAMBAHKAN INFORMASI LEBIH LANJUT:_*\n\n*⚡ @user (Sebutkan kepada pengguna)*\n*⚡ @subject (Nama grup)*\n*⚡ @desc (Deskripsi grup)*\n\n*INGAT BAHWA "@" ADALAH OPSIONAL*`}

//grupo-setdesc.js
const smsDest = () => { return `${bahasaAK['smsAvisoEG']()}*DESKRIPSI GRUP TELAH DIKONFIGURASI*`}

//grupo-setname.js
const smsNam1 = () => { return `${bahasaAK['smsAvisoEG']()}*NAMA GRUP TELAH DITETAPKAN*`}
const smsNam2 = () => { return `${bahasaAK['smsAvisoMG']()}*🙌 TULIS NAMA GRUP BARU*`}
const smsNam3 = () => { return `${bahasaAK['smsAvisoFG']()}*NAMA GRUP TIDAK BOLEH MEMILIKI LEBIH DARI 25 KARAKTER*`}

//grupo-restaurarEnlace.js
const smsRestGp = () => { return `${bahasaAK['smsAvisoEG']()}*TAUTAN GROUP TELAH DIRESET*`}
...
//propietario(a.js
const smsPropban1 = (usedPrefix, command, bot) => { return `${bahasaAK['smsAvisoMG']()}*TAG SESEORANG ATAU BALAS PESAN PENGGUNA ATAU TULIS NOMOR YANG INGIN ANDA BALAS DARI PERINTAH*\n\n*CONTOH:*\n*${usedPrefix + command} @${bot}*`}
const smsPropban2 = (bot) => { return `${bahasaAK['smsAvisoFG']()}*@${bot} TIDAK DAPAT DILARANG DENGAN PERINTAH INI* 😹`}
const smsPropban3 = (ownerNumber) => { return `${bahasaAK.smsAvisoIIG()}😳 *SAYA TIDAK BISA MELARKAN PEMILIK @${ownerNumber} DARI ${packname}*`}
const smsPropban4 = (number) => { return `${bahasaAK.smsAvisoIIG()}*TIDAK PERLU BAN LAGI @${number} YA SUDAH ADA* 😊`}
const smsPropban5 = () => { return `${bahasaAK['smsAvisoEG']()}*PENGGUNA BERHASIL DILARANG* 🙀`}
const smsPropban6 = (number, usr) => { return `${bahasaAK.smsAvisoAG()}*@${number} ANDA DILARANG OLEH @${usr} ANDA TIDAK DAPAT MENGGUNAKAN PERINTAH HINGGA SESEORANG MEMBALIKKAN BAN* 😿`}
const smsPropban7 = (usedPrefix, command, number) => { return `${bahasaAK['smsAvisoFG']()}*KESALAHAN MUNCUL, MUNGKIN PENGGUNA TIDAK DALAM DATABASE SAYA MENCOBA MENULIS ${usedPrefix + command} ${number}*\n\`\`\`JIKA KESALAHAN TERUS LANGSUNG LAPORKAN PERINTAH INI\`\`\``}
...
const smsJBConexionClose2 = () => { return `${bahasaAK['smsAvisoFG']()}🔴 *PERANGKAT ANDA TELAH TERHUBUNG*\n\n*ANDA HARUS TERHUBUNG LAGI UNTUK MENGGUNAKAN:\n#deletesesion`}
const smsreenvia = () => { return `*🟢 KIRIM ULANG PERINTAH...*`}
const smsSoloOwnerJB = () => { return `${bahasaAK['smsAvisoAG']()}*PERINTAH INI DINONAKTIFKAN OLEH PEMILIK SAYA*`}
const smsJBPrincipal = () => { return `${bahasaAK['smsAvisoAG']()}🔵 *UNTUK JADI SUB BOT MASUK KE NOMOR UTAMA*\n*ღ Masukkan tautan berikut:*\n`}
const smsJBConexion = () => { return `${bahasaAK['smsAvisoFG']()}🟡 *KONEKSI TELAH DITUTUP DENGAN CARA YANG TIDAK TERDUGA, KAMI AKAN MENCOBA MENGHUBUNGKAN KEMBALI...*`}
const smsJBConexionClose = () => { return `${bahasaAK['smsAvisoFG']()}🔴 *KONEKSI TELAH DITUTUP, ANDA HARUS MENGHUBUNGKAN SECARA MANUAL MENGGUNAKAN #jadibot PERINTAH DAN PINDAI ULANG KODE QR BARU*`}
const smsJBConexionTrue = () => { return `${bahasaAK['smsAvisoEG']()}🟢 *KONEKSI SUKSES!!!*`}
const smsJBConexionTrue2 = () => { return `${bahasaAK['smsAvisoEG']()}🟢 *KONEKSI SUKSES!!! ANDA DAPAT MENGHUBUNGKAN MENGGUNAKAN:*`}
const smsJBCargando = () => { return `${bahasaAK['smsAvisoIIG']()}⚪ *TERHUBUNG!! SILAKAN TUNGGU PESAN sedang DIMUAT...*\n\n♻️ *PILIHAN YANG TERSEDIA:*\n*» #stop _(Hentikan Fitur Sub Bot)_*\n*» #deletesesion _(Hapus semua jejak Sub Bot)_*\n*» #jadibot _(Dapatkan kode QR baru untuk menjadi Sub Bot)_*`}
const smsJBInfo1 = () => { return `💖 *LINK BERMANFAAT*`}
const smsJBInfo2 = () => { return `💖 *Fungsinya stabil, jika menimbulkan ketidaknyamanan Hubungi surat: centerAzkanBot@gmail.com*\n💝 *Anda dapat memberikan sumbangan sukarela melalui PayPal: ${global.paypal}*\n\n*Terima kasih banyak atas dukungan ${global.packname}*`}

//jadibot-deleteSesion.js
const smsJBDel = () => { return `${bahasaAK['smsAvisoAG']()}*GUNAKAN PERINTAH INI KE BOT UTAMA*`}
const smsJBAdios = () => { return `${bahasaAK['smsAvisoEG']()}*AKU AKAN MERINDUKANMU ${global.packname} SELAMAT TINGGAL!! 🥹*`}
const smsJBCerrarS = () => { return `${bahasaAK['smsAvisoEG']()}*ANDA TELAH KELUAR DAN MENGHAPUS SEMUA JEJAK*`}
const smsJBErr = () => { return `*ANDA TELAH LOG OUT SEBAGAI SUB BOT* ♻️`}

//comandos+18-adult.js
const smsContAdult = () => { return `${bahasaAK['smsAvisoAG']()}*PERINTAH 🔞 MEREKA CACAT, JIKA ANDA ADALAH CREATOR SAYA GUNAKAN #on modohorny*`}
...
const smsContacto4 = () => { return 'Kontak Resmi AzkanBot 🐈'}
