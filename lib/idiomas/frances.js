...
const smsLista1 = () => { return `🌟 INFORMATIONS AzkanBot 🌟`}
...
const smsLista7 = () => { return `🐈 INSTALLER AzkanBot 🐈`}
...
//afk-_afk.js
const smsAfkM1 = () => { return `${bahasaAK['smsAvisoEG']()}*DEJASTE DE ESTAR INACTIVO AFK*`} 
const smsAfkM2 = () => { return `*EL MOTIVO DE INACTIVIDAD ERA:*`} 
const smsAfkM3 = () => { return `*TIEMPO INACTIVO:*`} 
const smsAfkM4 = () => { return `${bahasaAK['smsAvisoAG']()}*NO ETIQUETES A ESTE(A) USUARIO(A)!! ESTÁ INACTIVO(A)*`} 
...
//afk-afk.js
const smsAfkM1A = () => { return `${bahasaAK['smsAvisoAG']()}*NO ETIQUETEN A*`} 
...
const smsJBConexionTrue2 = () => { return `${bahasaAK['smsAvisoEG']()}🟢 *CONEXIÓN CON ÉXITO!!! PUEDE CONECTARSE USANDO:*`}
