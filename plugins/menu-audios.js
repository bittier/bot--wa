...
let str = `
╭┄〔 *${wm}* 〕┄⊱
┊ *🎶 ${bahasaAK['smsConfi2']()} ${username}*
┊დ *${week}, ${date}*
┊დ *${bahasaAK['smsBotonM4']()} » ${Object.keys(global.db.data.users).length}* 
┊
┊დ *${bahasaAK['smsBotonM5']()} »* ${role}
┊დ *${bahasaAK['smsBotonM6']()} » ${level}*
┊დ *${bahasaAK['smsBotonM7']()} »* ${user.premiumTime > 0 ? '✅' : '❌'}
╰┄┄┄┄〔 *𓃠 ${vs}* 〕┄┄┄┄⊱
...
/*let menuA = `🎶 ${bahasaAK['smsConfi2']()} *${username}*`.trim()
let menuB = `
╭┄〔 *${wm}* 〕┄⊱
┊დ *${week}, ${date}*
┊დ *${bahasaAK['smsBotonM4']()} » ${Object.keys(global.db.data.users).length}* 
...
await conn.sendButtonVid(m.chat, pp, menuA, menuB, bahasaAK.smsBotonM1(), '.menu', bahasaAK.smsBotonM2(), '/allmenu', bahasaAK.smsBotonM3(), '#inventario', fkontak, adReply)
*/
const sections = [
{
title: `${bahasaAK.smsTex18()}`,
rows: [
{title: bahasaAK['smsLista2'](), description: null, rowId: `${usedPrefix}creadora`},
{title: bahasaAK['smsLista5'](), description: null, rowId: `${usedPrefix}infomenu`},
{title: bahasaAK['smsLista6'](), description: null, rowId: `${usedPrefix}allmenu`},  
...
const listMessage = {
text: `${wm}`,
footer: `*${bahasaAK['smsTex16']()}*
${bahasaAK['smsTex19']()}`,
title: null,
buttonText: `🔊 ${bahasaAK['smsTex16']()} 🔊`, 
sections }
