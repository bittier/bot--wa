...
let frep = { contextInfo: { externalAdReply: {title: wm, body: bahasaAK.smsCont18PornP2(), sourceUrl: redesMenu.getRandom(), thumbnail: await(await fetch(img16)).buffer() }}}
...
if (!db.data.chats[m.chat].modohorny && m.isGroup) throw `${bahasaAK['smsContAdult']()}`
try{
switch (command) {  
case "pornovid": case "nsfwvid":    
//await conn.sendFile(m.chat, enlace, null, `${bahasaAK['smsCont18Porn']()}\n${bahasaAK['smsBotonM7']()} » ${user.premiumTime > 0 ? '✅' : '❌'}`, null, null, {viewOnce: true}, frep, m)
await conn.sendFile(m.chat, enlace, null, `${bahasaAK['smsCont18Porn']()}\n${bahasaAK['smsBotonM7']()} » ${user.premiumTime > 0 ? '✅' : '❌'}`, m, null, {viewOnce: true})
//await conn.sendButton(m.chat, bahasaAK.smsCont18PornP(), `*_${bahasaAK['smsBotonM7']()}_* » ${user.premiumTime > 0 ? '✅' : '❌'}\n` + wm + ` : *${command[0].toUpperCase() + command.substring(1)}*`, enlace, [[bahasaAK.smsSigPrem(), `${usedPrefix + command}`], [`🥵 ${bahasaAK.lenguaje() == 'es' ? 'porno vid 2' : 'nsfw vid 2'} 🥵`.toUpperCase(), `${usedPrefix}${bahasaAK.lenguaje() == 'es' ? 'pornovid2' : 'nsfwvid2'}`]], m, frep) 
break  
    
case "pornovid2": case "nsfwvid2":    
await conn.sendFile(m.chat, enlace1, null, `${bahasaAK['smsCont18Porn']()}\n${bahasaAK['smsBotonM7']()} » ${user.premiumTime > 0 ? '✅' : '❌'}`, m, null, {viewOnce: true})
//await conn.sendButton(m.chat, bahasaAK.smsCont18PornP(), `*_${bahasaAK['smsBotonM7']()}_* » ${user.premiumTime > 0 ? '✅' : '❌'}\n` + wm + ` : *${command[0].toUpperCase() + command.substring(1)}*`, enlace1, [[bahasaAK.smsSigPrem(), `${usedPrefix + command}`], [`🥵 ${bahasaAK.lenguaje() == 'es' ? 'porno vid random' : 'nsfw vid random'} 🥵`.toUpperCase(), `${usedPrefix}${bahasaAK.lenguaje() == 'es' ? 'pornovidrandom' : 'nsfwvidrandom'}`]], m, frep) 
break 

case "pornovidlesbi": case "nsfwvidlesbi":       
await conn.sendFile(m.chat, enlace2, null, `${bahasaAK['smsCont18Porn']()}\n${bahasaAK['smsBotonM7']()} » ${user.premiumTime > 0 ? '✅' : '❌'}`, m, null, {viewOnce: true})
//await conn.sendButton(m.chat, bahasaAK.smsCont18PornP(), `*_${bahasaAK['smsBotonM7']()}_* » ${user.premiumTime > 0 ? '✅' : '❌'}\n` + wm + ` : *${command[0].toUpperCase() + command.substring(1)}*`, enlace2, [[bahasaAK.smsSigPrem(), `${usedPrefix + command}`]], m, frep)  
break 

case "pornovidgay": case "nsfwvidgay":       
await conn.sendFile(m.chat, enlace3, null, `${bahasaAK['smsCont18Porn']()}\n${bahasaAK['smsBotonM7']()} » ${user.premiumTime > 0 ? '✅' : '❌'}`, m, null, {viewOnce: true})
//await conn.sendButton(m.chat, bahasaAK.smsCont18PornP(), `*_${bahasaAK['smsBotonM7']()}_* » ${user.premiumTime > 0 ? '✅' : '❌'}\n` + wm + ` : *${command[0].toUpperCase() + command.substring(1)}*`, enlace3, [[bahasaAK.smsSigPrem(), `${usedPrefix + command}`]], m, frep)  
break 
    
case "pornovidbisexual": case "nsfwvidbisexual":       
await conn.sendFile(m.chat, enlace4, null, `${bahasaAK['smsCont18Porn']()}\n${bahasaAK['smsBotonM7']()} » ${user.premiumTime > 0 ? '✅' : '❌'}`, m, null, {viewOnce: true})
//await conn.sendButton(m.chat, bahasaAK.smsCont18PornP(), `*_${bahasaAK['smsBotonM7']()}_* » ${user.premiumTime > 0 ? '✅' : '❌'}\n` + wm + ` : *${command[0].toUpperCase() + command.substring(1)}*`, enlace4, [[bahasaAK.smsSigPrem(), `${usedPrefix + command}`]], m, frep)  
break 
    
case "pornovidrandom": case "nsfwvidrandom":       
await conn.sendFile(m.chat, enlace5, null, `${bahasaAK['smsCont18Porn']()}\n${bahasaAK['smsBotonM7']()} » ${user.premiumTime > 0 ? '✅' : '❌'}`, m, null, {viewOnce: true})
//await conn.sendButton(m.chat, bahasaAK.smsCont18PornP(), `*_${bahasaAK['smsBotonM7']()}_* » ${user.premiumTime > 0 ? '✅' : '❌'}\n` + wm + ` : *${command[0].toUpperCase() + command.substring(1)}*`, enlace5, [[bahasaAK.smsSigPrem(), `${usedPrefix + command}`], [`🥵 ${bahasaAK.lenguaje() == 'es' ? 'porno vid' : 'nsfw vid'} 🥵`.toUpperCase(), `${usedPrefix}${bahasaAK.lenguaje() == 'es' ? 'pornovid' : 'nsfwvid'}`]], m, frep)  
break 
