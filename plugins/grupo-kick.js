...
try{
let texto = `${bahasaAK['smskick1']()}${usedPrefix + command} @${global.owner[0][0]}*`
const fkontak = { "key": { "participants":"0@s.whatsapp.net", "remoteJid": "status@broadcast", "fromMe": false, "id": "Halo" }, "message": { "contactMessage": { "vcard": `BEGIN:VCARD\nVERSION:3.0\nN:Sy;Bot;;;\nFN:y\nitem1.TEL;waid=${m.sender.split('@')[0]}:${m.sender.split('@')[0]}\nitem1.X-ABLabel:Ponsel\nEND:VCARD` }}, "participant": "0@s.whatsapp.net"}

if (!global.db.data.settings[conn.user.jid].restrict) return conn.sendButton(m.chat, wm, `${bahasaAK['smsAvisoAG']()}${bahasaAK['smsSoloOwner']()}`, null, [[bahasaAK.smsEncender(), `${usedPrefix}on restringir`]], fkontak, m)
...
if(conn.user.jid.includes(mentioned)) return conn.reply(m.chat, `${bahasaAK['smskick1']()}${usedPrefix + command} @${global.owner[0][0]}*`, fkontak, m)
//let eliminar = await conn.groupParticipantsUpdate(m.chat, [mentioned], 'remove')
let done = `${bahasaAK['smsAvisoEG']()}*@${mentioned.split("@")[0]} ${bahasaAK['smskick2']()}*`
let err1 = `${bahasaAK['smsAvisoFG']()}*@${mentioned.split("@")[0]} ${bahasaAK['smskick3']()}*`
let err2 = `${bahasaAK['smsAvisoAG']()}*@${mentioned.split("@")[0]} ${bahasaAK['smskick4']()}*`
...
if (!global.db.data.settings[conn.user.jid].restrict) throw `${bahasaAK['smsAvisoAG']()}𝙀𝙎𝙏𝘼 𝙍𝙀𝙎𝙏𝙍𝙄𝙉𝙂𝙄𝘿𝙊 𝙀𝙇 𝘾𝙊𝙈𝘼𝙉𝘿𝙊\n#on restrict | #off restrict\n𝙀𝙇/𝙇𝘼 𝙋𝙍𝙊𝙋𝙄𝙀𝙏𝘼𝙍𝙄𝙊(𝘼) 𝘿𝙀𝘽𝙀 𝘼𝘾𝙏𝙄𝙑𝘼𝙍 𝙀𝙇 𝘾𝙊𝙈𝘼𝙉𝘿𝙊\n\n 𝙊𝙒𝙉𝙀𝙍 𝙈𝙐𝙎𝙏 𝘼𝘾𝙏𝙄𝙑𝘼𝙏𝙀 𝙏𝙃𝙀 𝘾𝙊𝙈𝙈𝘼𝙉𝘿\n#on restrict | #off restrict`
