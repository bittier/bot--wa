...
┃┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈
┃➥ *AUTOREAD*
┃ღ ${autoread ? '*AKTIF ✔*' : '*Tidak Aktif ✘*'}
┃┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈
┃➥ *RESTRICT* 
┃ღ ${restrict ? '*Aktif ✔*' : '*Tidak Aktif ✘*'} 
┃
...
conn.sendHydrated(m.chat, info, wm, pp, 'https://github.com/GataNina-Li/AzkanBot-MD', 'AzkanBot-MD', null, null, [
