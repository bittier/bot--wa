...
if (data.exists)
m.reply(`${bahasaAK['smsCont1']()}\n\n${bahasaAK['smsCont2']()}\n*_${name}_*\n\n${bahasaAK['smsCont3']()}\n*_${m.sender}_*\n\n${bahasaAK['smsCont4']()}\n*_${m.text}_*\n\n${bahasaAK['smsCont5']()}\n\`\`\`${format(e)}\`\`\`\n\n${bahasaAK['smsCont6']()}`.trim(), data.jid)
}}}
if (!opts['restrict'])
...
this.reply(m.chat, `${bahasaAK['smsCont7']()} *${usedPrefix}buy*`, m)
continue //Sin límite
}
if (plugin.level > _user.level) {
this.reply(m.chat, `${bahasaAK['smsCont9']()} *${plugin.level}* ${bahasaAK['smsCont10']()} *${_user.level}* ${bahasaAK['smsCont11']()} *${usedPrefix}nivel*`, m)
...
if (m.limit)
m.reply(+m.limit + bahasaAK.smsCont8())
}
if (m.money)
...
this.sendMessage(id, { text:`*${bahasaAK['smsAvisoAG']()}${bahasaAK['smsInt1']()} @${user.split("@")[0]} ${bahasaAK['smsInt2']()}*`, mentions: [user] }, { quoted: null });          
...
"thumbnail": apii.data, 
"title": [wm, '😻 𝗦𝘂𝗽𝗲𝗿 ' + gt + ' 😻', '🌟 centerAzkanBot.gmail.com'].getRandom(),
...
if (nk.isGroup == false) {
if (nk.status == "offer") {
let callmsg = await this.reply(nk.from, `${bahasaAK['smsCont15']()} *@${nk.from.split('@')[0]}*, ${nk.isVideo ? bahasaAK.smsCont16() : bahasaAK.smsCont17()} ${bahasaAK['smsCont18']()}`, false, { mentions: [nk.from] })
...
const antideleteMessage = `*╭━━⬣ ${bahasaAK['smsCont19']()} ⬣━━ 𓃠*
${bahasaAK['smsCont20']()} @${participant.split`@`[0]}
${bahasaAK['smsCont21']()}
*╰━━━⬣ ${bahasaAK['smsCont19']()} ⬣━━╯*`.trim();
...
let msg = {
rowner: bahasaAK['smsRowner'](),
owner: bahasaAK['smsOwner'](),
mods: bahasaAK['smsMods'](),
premium: bahasaAK['smsPremium'](),
group: bahasaAK['smsGroup'](),
private: bahasaAK['smsPrivate'](),
admin: bahasaAK['smsAdmin'](),
botAdmin: bahasaAK['smsBotAdmin'](),
unreg: bahasaAK['smsUnreg'](),
restrict: bahasaAK['smsRestrict'](),
}[type]
//if (msg) return m.reply(msg)
let tg = { quoted: m, userJid: conn.user.jid }
let prep = generateWAMessageFromContent(m.chat, { extendedTextMessage: { text: msg, contextInfo: { externalAdReply: { title: bahasaAK.smsAvisoAG().slice(0,-2), body: [wm, '😻 𝗦𝘂𝗽𝗲𝗿 ' + gt + ' 😻', '🌟 centerAzkanBot.gmail.com'].getRandom(), thumbnail: gataImg.getRandom(), sourceUrl: [md, nna, nn, nnn, yt, ig, paypal, fb].getRandom() }}}}, tg)
