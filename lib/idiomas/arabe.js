...
const smsLista1 = () => { return `🌟 معلومات AzkanBot 🌟`}
...
const smsLista7 = () => { return `🐈 تثبيت AzkanBot 🐈`}
...
//_allantilink.js
const smsTextoYT = () => { return '😻 ممتاز AzkanBot-MD - WhatsApp '}
...
const smsCont7 = () => { return `${global.bahasaAK['smsAvisoAG']()}*ليس لديها ماسات!! 💎 يمكنك الذهاب إلى المتجر باستخدام الأمر*`}
const smsCont8 = () => { return ` *الماس 💎 تستخدم*`}
const smsCont9 = () => { return `${global.bahasaAK['smsAvisoAG']()}*بحاجة إلى المستوى ➡️*`}
...
//_antilink.js
const smsAdwa = () => { return `${global.bahasaAK['smsAvisoEG']()}*نظرًا لأنك مسؤول في هذه المجموعة ، فلن تتم إزالتك*`}
const smsEnlaceWat = () => { return `${bahasaAK['smsAvisoAG']()}*تم اكتشاف رابط WHATSAPP محظور في هذه المجموعة*\n\n*لقد شرعت في حذفك*`}

//_antilink2.js
const smsEnlaceWatt = () => { return `${bahasaAK['smsAvisoAG']()}تم اكتشاف ارتباط محظور يحتوي على HTTPS في هذه المجموعة\n\nلقد شرعت في حذفك`}
...
//خطأ
const smsMalError = () => { return `${bahasaAK['smsAvisoFG']()}\`\`\`لقد حدث خطأ غير متوقع.\`\`\``}
const smsMalError2 = () => { return `${bahasaAK['smsAvisoFG']()}\`\`\`لقد نشأ إزعاج. حاول مرة أخرى.\`\`\``}
const smsMalError3 = () => { return `${bahasaAK['smsAvisoFG']()}\`\`\`حدث خطأ ما ، أبلغ عن هذا الأمر باستخدام:\`\`\`\n`}
...
const smsModP2 = () => { return `تمكين الوظيفة حتى يتمكن الجميع من استخدام AzkanBot`}
const smsModAd1 = () => { return `🛂 وضع المشرف`}
const smsModAd2 = () => { return `سيتمكن المسؤولون فقط من استخدام AzkanBot في المجموعات`}
...
//_autosticker.js
const smsAutoStik = () => { return `${bahasaAK['smsAvisoFG']()}*يجب ألا يزيد الفيديو عن 7 ثوانٍ.*`} 
...
//afk-afk.js
const smsAfkQ1 = (usedPrefix, command) => { return `${bahasaAK['smsAvisoMG']()}*اكتب سبب عدم نشاطه (AFK)*\n\n*مثال:*\n*${usedPrefix + command}* انا ذاهب للقيام بالواجب المنزلي`} 
const smsAfkQ2 = () => { return `${bahasaAK['smsAvisoMG']()}*يجب أن يكون هناك 10 أحرف على الأقل هي السبب*`} 
const smsAfkM1A = () => { return `*لا تضع علامة على*`} 
const smsAfkM1B = () => { return `*سيكون AFK غير نشط*\n\n*سبب عدم نشاط AFK:*`} 

//anonymous_chat.js
const smsChatAn1 = () => { return `${bahasaAK['smsAvisoFG']()}*أنت لست في دردشة مجهولة*`} 
...
const smsChatAn4 = () => { return `${bahasaAK['smsAvisoRG']()}🪐 *لقد تركت الدردشة المجهولة*`} 
const smsChatAn5 = () => { return `${bahasaAK['smsAvisoAG']()}*ترك المستخدم الآخر الدردشة المجهولة*`}  
const smsChatAn6 = () => { return `*إذا كنت تريد الذهاب إلى دردشة أخرى مجهولة ، فاستخدم الأمر #start أو استخدم الزر أدناه*\n`} 
const smsChatAn7 = () => { return `${bahasaAK['smsAvisoAG']()}*أنت لا تزال في دردشة مجهولة أو تنتظر أن ينضم شخص ما إلى الدردشة*`} 
...
const smsChatAn10 = () => { return `${bahasaAK['smsAvisoEG']()}✨ *يمكنهم الدردشة الآن*`} 
const smsChatAn11 = () => { return `*شخص ما انضم إلى الدردشة المجهولة!!*`} 
const smsChatAn12 = () => { return `❇️ مستخدم آخر`} 
const smsChatAn13 = () => { return `${bahasaAK['smsAvisoRG']()}🐈 *في انتظار انضمام شخص ما إلى الدردشة المجهولة ، يرجى التحلي بالصبر*`} 
...
const smsMalused2 = () => { return `${bahasaAK['smsAvisoMG']()}🐈 *يجب عليك استخدام الأمر مثل هذا المثال:*\n`}
const smsMalused3 = () => { return `${bahasaAK['smsAvisoMG']()}🐈 *يجب عليك استخدام الأمر أو الرد على رسالة شخص ما مثل هذا المثال:*\n`}
...
//grupo-add.js
const smsAddB1 = () => { return `${bahasaAK['smsAvisoFG']()}*لا يمكن إضافة الرقم ، يرجى التحقق من صحته ، أو ربما خرج مؤخرًا أو تم تعيين خصوصيتك.*`}
const smsAddB2 = () => { return `${bahasaAK['smsAvisoFG']()}*لا يمكن إضافة الرقم أو التحقق من صحته أو إضافته يدويًا.*`}
...
const smsAdveu1 = () => { return `${bahasaAK['smsAvisoAG']()}*يمكن استخدامه فقط في حالة تنشيط الوظيفة:*\n`}
const smsAdveu2 = () => { return 'سبب'}
const smsAdveu3 = () => { return `${bahasaAK['smsAvisoMG']()}*تذكر أن تكتب سبب التحذير*\n`}
...
//grupo-kick.js
const smskick1 = () => { return `${bahasaAK['smsAvisoAG']()}*ضع علامة على الشخص أو رد على رسالة الشخص الذي تريد حذفه*\n\n*مثال: `}
...
//grupo-setbye.js
const smsSetB = () => { return `${bahasaAK['smsAvisoEG']()}*تم تكوين وداع المجموعة*`}
const smsSetB2 = () => { return `${bahasaAK['smsAvisoIIG']()}🙌 *_اكتب رسالة الوداع_*\n*_اختياري يمكنك استخدام ما هو مع "@" لإضافة المزيد من المعلومات:_*\n\n*⚡ @user (أذكر للمستخدم)*\n\n*تذكر أن علامة "@" هي اختيارية*`}

//grupo-setwelcome.js
const smsSetW = () => { return `${bahasaAK['smsAvisoEG']()}*تم إعداد ترحيب المجموعة*`}
const smsSetW2 = () => { return `${bahasaAK['smsAvisoIIG']()}🙌 *_اكتب رسالة الترحيب_*\n*_اختياري يمكنك استخدام ما هو مع "@" لإضافة المزيد من المعلومات:_*\n\n*⚡ @user (أذكر للمستخدم)*\n*⚡ @subject (أسم المجموعة)*\n*⚡ @desc (وصف المجموعة)*\n\n*تذكر أن علامة "@" اختيارية*`}

//grupo-setdesc.js
const smsDest = () => { return `${bahasaAK['smsAvisoEG']()}*تم تكوين وصف المجموعة*`}

//grupo-setname.js
const smsNam1 = () => { return `${bahasaAK['smsAvisoEG']()}*تم تعيين اسم المجموعة*`}
const smsNam2 = () => { return `${bahasaAK['smsAvisoMG']()}*🙌 اكتب اسم المجموعة الجديد*`}
const smsNam3 = () => { return `${bahasaAK['smsAvisoFG']()}*يجب ألا يحتوي اسم المجموعة على أكثر من 25 حرفًا*`}

//grupo-restaurarEnlace.js
const smsRestGp = () => { return `${bahasaAK['smsAvisoEG']()}*تمت إعادة تعيين ارتباط المجموعة*`}
...
//propietario(a.js
const smsPropban1 = (usedPrefix, command, bot) => { return `${bahasaAK['smsAvisoMG']()}*ضع علامة على أحد الأشخاص أو رد على رسالة المستخدم أو اكتب الرقم الذي تريد حظره من الأوامر*\n\n*مثال:*\n*${usedPrefix + command} @${bot}*`}
const smsPropban2 = (bot) => { return `${bahasaAK['smsAvisoFG']()}*@${bot} لا يمكن حظره بهذا الأمر* 😹`}
const smsPropban3 = (ownerNumber) => { return `${bahasaAK.smsAvisoIIG()}😳 *لا يمكنني منع المالك @${ownerNumber} من ${packname}*`}
const smsPropban4 = (number) => { return `${bahasaAK.smsAvisoIIG()}*ليس من الضروري الحظر مرة أخرى @${number} نعم إنه موجود بالفعل* 😊`}
const smsPropban5 = () => { return `${bahasaAK['smsAvisoEG']()}*المستخدم محظور بنجاح* 🙀`}
const smsPropban6 = (number, usr) => { return `${bahasaAK.smsAvisoAG()}*@${number} أنت محظور من قبل @${usr} لا يمكنك استخدام الأوامر حتى يقوم أحدهم بعكس الحظر* 😿`}
const smsPropban7 = (usedPrefix, command, number) => { return `${bahasaAK['smsAvisoFG']()}*ظهر خطأ ، ربما يكون المستخدم غير موجود في قاعدة بياناتي ، حاول الكتابة ${usedPrefix + command} ${number}*\n\`\`\`إذا استمر الخطأ في الإبلاغ عن هذا الأمر\`\`\``}
...
*➡️ باستخدام هاتف خلوي أو كمبيوتر شخصي آخر ، امسح رمز الاستجابة السريعة هذا ليصبح روبوتًا فرعيًا*\n\n*1️⃣ انتقل إلى النقاط الثلاث في الزاوية اليمنى العليا*\n*2️⃣ انتقل إلى خيار الأجهزة المقترنة*\n*3️⃣ امسح رمز الاستجابة السريعة هذا لتسجيل الدخول*`}
const smsJBConexionClose2 = () => { return `${bahasaAK['smsAvisoFG']()}🔴 *تم فصل الجهاز*\n\n*سيكون عليك الاتصال مرة أخرى للاستخدام:\n#deletesesion`}
const smsreenvia = () => { return `*🟢 أعد إرسال الأمر...*`}
const smsSoloOwnerJB = () => { return `${bahasaAK['smsAvisoAG']()}*تم تعطيل هذا الأمر من قبل المالك*`}
const smsJBPrincipal = () => { return `${bahasaAK['smsAvisoAG']()}🔵 *لكي تكون تابعًا ثانويًا ، انتقل إلى الرقم الرئيسي*\n*ღ أدخل الرابط التالي:*\n`}
const smsJBConexion = () => { return `${bahasaAK['smsAvisoFG']()}🟡 *تم إغلاق الاتصال بطريقة غير متوقعة ، سنحاول إعادة الاتصال ...*`}
const smsJBConexionClose = () => { return `${bahasaAK['smsAvisoFG']()}🔴 *تم إغلاق الاتصال ، يجب عليك الاتصال يدويًا باستخدام الأمر #jadibot وإعادة إنشاء رمز الاستجابة السريعة الجديد*`}
const smsJBConexionTrue = () => { return `${bahasaAK['smsAvisoEG']()}🟢 *اتصال ناجح!!!*`}
const smsJBConexionTrue2 = () => { return `${bahasaAK['smsAvisoEG']()}🟢 *اتصال ناجح!!! يمكنك الاتصال باستخدام:*`}
const smsJBCargando = () => { return `${bahasaAK['smsAvisoIIG']()}⚪ *متصل!! يرجى الانتظار يتم تحميل الرسائل ...*\n\n♻️ *الخيارات المتاحة:*\n*» #stop _(ميزة Stop Sub Bot)_*\n*» #deletesesion _(احذف كل آثار Sub Bot)_*\n*» #jadibot _(احصل على رمز QR جديد ليكون Sub Bot)_*`}
const smsJBInfo1 = () => { return `💖 *رابط مفيد*`}
const smsJBInfo2 = () => { return `💖 *الوظيفة مستقرة ، إذا واجهت أي إزعاج ، فاتصل بالبريد: centerAzkanBot@gmail.com*\n💝 *يمكنك تقديم تبرع طوعي عن طريق PayPal: ${global.paypal}*\n\n*شكرا جزيلا على الدعم ${global.packname}*`}

//jadibot-deleteSesion.js
const smsJBDel = () => { return `${bahasaAK['smsAvisoAG']()}*استخدم هذا الأمر مع الروبوت الرئيسي*`}
const smsJBAdios = () => { return `${bahasaAK['smsAvisoEG']()}*سأفتقدك ${global.packname} وداعا!! 🥹*`}
const smsJBCerrarS = () => { return `${bahasaAK['smsAvisoEG']()}*لقد قمت بتسجيل الخروج وحذف جميع المسارات*`}
const smsJBErr = () => { return `*لقد قمت بتسجيل الخروج كبرنامج ثانوي* ♻️`}

//comandos+18-adult.js
const smsContAdult = () => { return `${bahasaAK['smsAvisoAG']()}*الأوامر 🔞 إنهم معاقون ، إذا كنت منشئ المحتوى الخاص بي #on modohorny*`}
...
const smsContacto4 = () => { return 'جهة اتصال AzkanBot الرسمية 🐈'}
