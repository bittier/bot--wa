...
user.warn += 1
if (!(user.warn >= 4)) await m.reply(`${user.warn == 1 ? `*@${m.sender.split`@`[0]}*` : `*@${m.sender.split`@`[0]}*`}, ${bahasaAK['smsToxic1']()} (${isToxic}) ${bahasaAK['smsToxic2']()} ${bahasaAK['smsToxic3']()} *${user.warn}/4*\n\n${wm}`, false, { mentions: [m.sender] })}
/*await conn.sendButton(m.chat,`${user.warn == 1 ? `*@${m.sender.split`@`[0]}*` : `*@${m.sender.split`@`[0]}*`} *${bahasaAK['smsToxic1']()} (${isToxic}) ${bahasaAK['smsToxic2']()}*`, `${bahasaAK['smsToxic3']()} *${user.warn}/4*\n\n${wm}`, img, [
[bahasaAK.smsToxic4(), 'ok'],
[bahasaAK.smsToxic5(), '.off antitoxic'],
[bahasaAK.smsConMenu(), '/menu']], false, { mentions: [m.sender] })}*/

if (user.warn >= 4) {
user.warn = 0
await m.reply(`*${bahasaAK['smsToxic6']()}*\n*@${m.sender.split`@`[0]} ${bahasaAK['smsToxic7']()}*`, false, { mentions: [m.sender] })
user.banned = true
