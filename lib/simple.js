...
export function protoType() {
    ...
    Number.prototype.toTimeString = function toTimeString() {
        ...
        return (
(days ? `${days} ${bahasaAK.smsAfkResultTime[0]} ` : '') + (hours ? `${hours} ${bahasaAK.smsAfkResultTime[1]} ` : '') +
(minutes ? `${minutes} ${bahasaAK.smsAfkResultTime[2]} ` : '') + (seconds ? `${seconds} ${bahasaAK.smsAfkResultTime[3]}` : '')).trim()
    }
